...
public class Program {
	...
	public static void main(String[] args) {
		...
		System.out.println("Criação de conta pessoa física. Digite os dados do titular:");
		System.out.println("Nome: ");
		conta1.setNomeTitular(teclado.nextLine());
		System.out.println("Digite o número da conta com 8 digitos: ");
		...
		System.out.println("Digite [1] para depósito - [2] para saque e [3] para finalizar");
